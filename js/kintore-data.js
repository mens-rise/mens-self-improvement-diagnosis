...
window.MEAL_PLANS = {
  ...
  ecto_lean: {
    ...
    meals: [
      { time: '07:00', title: '朝食', items: ['セブン 鮭おにぎり 150円 ×2', 'セブン サラダチキン プレーン 268円', 'ANBEEKプロテイン 1杯（牛乳200ml）'], kcal: 720, p: 52 },
      { time: '12:00', title: '昼食', items: ['ローソン 鶏むね&もち麦ボウル 598円', 'ゆで卵 ×2', 'バナナ 1本'], kcal: 780, p: 48 },
      { time: '15:00', title: '間食', items: ['ANBEEKプロテイン ×1', 'おにぎり 1個 or 和菓子（だんご等）'], kcal: 320, p: 22 },
  ...
  ecto_athlete: {
    ...
    meals: [
      ...
      { time: '15:00', title: '間食①', items: ['おにぎり ×2', 'ANBEEKプロテイン'], kcal: 450, p: 28 },
      { time: '19:00', title: '夕食', items: ['白米 250g', 'サーモン塩焼き 150g', 'ブロッコリー', '味噌汁'], kcal: 850, p: 45 },
      { time: '22:00', title: '間食②', items: ['ギリシャヨーグルト 170g', 'ANBEEKプロテイン'], kcal: 280, p: 25 }
    ]
  },
  // 筋肉質型 × 細マッチョ
  meso_lean: {
    ...
    meals: [
      ...
      { time: '15:00', title: '間食', items: ['ANBEEKプロテイン 1杯', 'ナッツ 20g'], kcal: 260, p: 22 },
  ...
  meso_athlete: {
    ...
    meals: [
      { time: '07:00', title: '朝食', items: ['オートミール 60g', '卵 3個', 'バナナ 2本', 'ANBEEKプロテイン'], kcal: 720, p: 48 },
      { time: '12:00', title: '昼食', items: ['鶏むね 200g', '白米 200g', 'キャベツ', '味噌汁'], kcal: 780, p: 55 },
      { time: '15:00', title: '間食', items: ['おにぎり 1個', 'ANBEEKプロテイン', 'ナッツ'], kcal: 420, p: 28 },
  ...
  endo_lean: {
    ...
    meals: [
      ...
      { time: '15:00', title: '間食', items: ['ANBEEKプロテイン 1杯（水割り）', 'ブラックコーヒー'], kcal: 130, p: 22 },
  ...
  endo_athlete: {
    ...
    meals: [
      { time: '07:00', title: '朝食', items: ['オートミール 40g', '卵 2個', 'ANBEEKプロテイン'], kcal: 520, p: 42 },
      { time: '12:00', title: '昼食', items: ['鶏むね 180g', '玄米 100g', 'サラダ', 'ゆで卵'], kcal: 620, p: 52 },
      { time: '15:00', title: '間食', items: ['ANBEEKプロテイン', 'ゆで卵 1個'], kcal: 200, p: 28 },
...
window.CONVENIENCE_LIST = {
  ecto: [
    ...
    { name: 'ANBEEK プロテイン（ヨーグルト味）', price: 'Amazon月契約', nut: 'P24g／C3g' },
  ...
  meso: [
    ...
    { name: 'ANBEEK プロテイン', price: 'Amazon月契約', nut: 'P24g／C3g' },
